...
export const CHECKLIST_ITEMS: ChecklistItemDefinition[] = [
  ...
  { id: 2, category: cat(1), title: 'Robots.txt has no syntax errors', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['ROBOTS_TXT_SYNTAX_ERROR'] },
  { id: 3, category: cat(1), title: 'Robots.txt does not block important pages or resources', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['ROBOTS_TXT_BLOCKS_IMPORTANT'] },
  ...
  { id: 5, category: cat(1), title: 'Sitemap is valid XML and correctly formatted', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['SITEMAP_INVALID_XML'] },
  { id: 6, category: cat(1), title: 'Sitemap is referenced in robots.txt', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['ROBOTS_TXT_NO_SITEMAP_REF'] },
  { id: 7, category: cat(1), title: 'Sitemap URLs match the canonical versions of pages', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['SITEMAP_CANONICAL_MISMATCH'] },
  ...
  { id: 15, category: cat(1), title: 'CSS, JS, and images are not blocked by robots.txt', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['ROBOTS_TXT_BLOCKS_ASSETS'] },
  ...
  { id: 31, category: cat(2), title: 'Breadcrumbs use BreadcrumbList JSON-LD schema markup', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['MISSING_BREADCRUMB_SCHEMA'] },
  { id: 32, category: cat(2), title: 'Pagination uses correct rel=next/prev or canonical handling', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['PAGINATION_BROKEN'] },
  ...
  // ======================================================================
  { id: 54, category: cat(4), title: 'Largest Contentful Paint (LCP) is under 2.5 seconds', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['POOR_LCP'], note: NEEDS_PAGESPEED_API },
  { id: 55, category: cat(4), title: 'Cumulative Layout Shift (CLS) score is below 0.1', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['POOR_CLS'], note: NEEDS_PAGESPEED_API },
  { id: 56, category: cat(4), title: 'Interaction to Next Paint (INP) is under 200ms', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['POOR_INP'], note: NEEDS_PAGESPEED_API },
  ...
  { id: 71, category: cat(5), title: 'All schema validated — no critical errors in Rich Results Test', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['SCHEMA_VALIDATION_FAILED'], note: 'Requires Google Rich Results Test API.' },
  ...
  { id: 73, category: cat(5), title: 'Article / BlogPosting schema on blog or news pages', severityWhenFailing: 'Low', failureStatus: 'Notice', matchingIssueTypes: ['MISSING_ARTICLE_SCHEMA'] },
  { id: 74, category: cat(5), title: 'Product schema on product pages (price, availability, rating)', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['MISSING_PRODUCT_SCHEMA'] },
  ...
  { id: 76, category: cat(5), title: 'Breadcrumb schema matches visible breadcrumb navigation', severityWhenFailing: 'Low', failureStatus: 'Notice', matchingIssueTypes: ['MISSING_BREADCRUMB_SCHEMA'] },
  ...
  { id: 79, category: cat(5), title: 'og:image meets minimum size requirements (1200x630px)', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['OG_IMAGE_TOO_SMALL'] },
  ...
  // ======================================================================
  { id: 81, category: cat(6), title: 'Render-blocking CSS moved to non-blocking or inlined', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['RENDER_BLOCKING_CSS'], note: NEEDS_PAGESPEED_API },
  { id: 82, category: cat(6), title: 'Render-blocking JS deferred or loaded asynchronously', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['RENDER_BLOCKING_JS'], note: NEEDS_PAGESPEED_API },
  ...
  { id: 87, category: cat(6), title: 'Total page weight is under 2 MB', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['LARGE_PAGE_SIZE', 'EXCESSIVE_PAGE_WEIGHT'] },
  ...
  { id: 90, category: cat(6), title: 'No layout shifts caused by ads, embeds, or late images', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['POOR_CLS'], note: NEEDS_PAGESPEED_API },
  ...
  { id: 94, category: cat(7), title: 'HSTS (Strict-Transport-Security) header implemented', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['MISSING_HSTS_HEADER'] },
  { id: 95, category: cat(7), title: 'Content-Security-Policy (CSP) header present', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['MISSING_CSP_HEADER'] },
  { id: 96, category: cat(7), title: 'X-Frame-Options header set to prevent clickjacking', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['MISSING_X_FRAME_OPTIONS'] },
  { id: 97, category: cat(7), title: 'Referrer-Policy header configured appropriately', severityWhenFailing: 'Low', failureStatus: 'Notice', matchingIssueTypes: ['MISSING_REFERRER_POLICY'] },
  { id: 98, category: cat(7), title: 'X-Content-Type-Options: nosniff header present', severityWhenFailing: 'Low', failureStatus: 'Notice', matchingIssueTypes: ['MISSING_X_CONTENT_TYPE_OPTIONS'] },
  { id: 99, category: cat(7), title: 'Permissions-Policy header configured', severityWhenFailing: 'Low', failureStatus: 'Notice', matchingIssueTypes: ['MISSING_PERMISSIONS_POLICY'] },
  { id: 100, category: cat(7), title: 'No flagged malware / unsafe scripts (GSC Security Issues)', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['GSC_SECURITY_ISSUE'], note: NEEDS_GSC_API },
  ...
  { id: 102, category: cat(7), title: 'No sensitive data exposed in source code or URL parameters', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: [], note: 'Detection: API key / secret pattern scan (planned).' },

  // ======================================================================
  // 8. INTERNATIONAL SEO (8 items)
  // ======================================================================
  { id: 103, category: cat(8), title: 'Hreflang tags implemented for all multilingual pages', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['HREFLANG_MISSING'] },
  { id: 104, category: cat(8), title: 'Hreflang values use correct BCP 47 codes (e.g. en-US)', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['HREFLANG_INVALID_CODE'] },
  { id: 105, category: cat(8), title: 'Every hreflang set includes a self-referencing annotation', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['HREFLANG_MISSING_SELF'] },
  { id: 106, category: cat(8), title: 'Hreflang tags are fully reciprocal across all versions', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['HREFLANG_NOT_RECIPROCAL'] },
  { id: 107, category: cat(8), title: 'x-default hreflang set for language selector / fallback', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['HREFLANG_MISSING_X_DEFAULT'] },
  ...
  { id: 123, category: cat(10), title: 'Google Search Console verified, no manual actions pending', severityWhenFailing: 'High', failureStatus: 'Error', matchingIssueTypes: ['GSC_NOT_VERIFIED', 'GSC_HAS_MANUAL_ACTION'], note: NEEDS_GSC_API },
  ...
  { id: 125, category: cat(10), title: 'GA / GTM tags firing on every page', severityWhenFailing: 'Medium', failureStatus: 'Warning', matchingIssueTypes: ['GTM_TAG_MISSING'] },
  ...
  { id: 127, category: cat(10), title: 'Site registered in Bing Webmaster Tools', severityWhenFailing: 'Low', failureStatus: 'Notice', matchingIssueTypes: ['BING_NOT_VERIFIED'], note: 'Requires Bing Webmaster Tools API integration.' },
