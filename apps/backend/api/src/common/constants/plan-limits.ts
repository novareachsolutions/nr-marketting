export const PLAN_LIMITS = {
  FREE: {
    ...
    maxDomainOverviewsPerDay: 3,
    maxOrganicRankingsPerDay: 3,
    maxTopPagesPerDay: 3,
    maxCompareDomainsPerDay: 3,
    maxKeywordGapPerDay: 3,
    maxBacklinkGapPerDay: 3,
    whiteLabel: false,
    maxTeamMembers: 1,
  ...
  PRO: {
    ...
    maxDomainOverviewsPerDay: 50,
    maxOrganicRankingsPerDay: 50,
    maxTopPagesPerDay: 50,
    maxCompareDomainsPerDay: 50,
    maxKeywordGapPerDay: 50,
    maxBacklinkGapPerDay: 50,
    whiteLabel: false,
    maxTeamMembers: 3,
  ...
  AGENCY: {
    ...
    maxDomainOverviewsPerDay: -1,
    maxOrganicRankingsPerDay: -1,
    maxTopPagesPerDay: -1,
    maxCompareDomainsPerDay: -1,
    maxKeywordGapPerDay: -1,
    maxBacklinkGapPerDay: -1,
    whiteLabel: true,
    maxTeamMembers: 10,
